...
// the method looks if data is null if not then it goes to  search(int data)
...
//searches the number if it is in the tree
//this method looks if data equals this->data 
